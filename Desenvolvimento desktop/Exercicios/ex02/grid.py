...
app.grid_columnconfigure(0,weight=0) #configuração de coluna - A coluna 0 não cresce
app.grid_columnconfigure(1,weight=1) # A coluna 1 cresce, ocupando espaço extra
